    ...
    <div class="container mt-3">
        ...
        <form  action="{{url('/')}}/customer" method="post" >
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" placeholder="enter your email" name="address" value="{{old('address')}}"/>
                <span class="text-danger">
                    @error('address')
                    {{$message}}
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" placeholder="enter your email" name="state" value="{{old('state')}}"/>
                <span class="text-danger">
                    @error('state')
                    {{$message}}
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" placeholder="enter your email" name="city" value="{{old('city')}}"/>  
                <span class="text-danger">
                    @error('city')
                    {{$message}}
